...
<head>
  ...
  <title>Thiago Araujo - Desenvolvedor FullStack</title>
  <style>
    body {
...
<div class="container">
  <h1>Olá, eu sou a Thiago Araujo, Front-End caminhando para minha jornada FullStack pela Kenzie Academy!!!</h1>
...
<div style="display: inline_block"><br>
  ...
  <div class="stats">
    <!-- Adicione uma descrição à seção de estatísticas -->
    <h3>Estatísticas do GitHub:</h3>
    <ul>
      <li>Commits em todos os repositórios.</li>
      <li>Linguagens mais usadas nos projetos.</li>
    </ul>
  </div>
 <div class="social-icons">
    <!-- Adicione ícones para as redes sociais -->
 ...
 **Atividade no GitHub:**
- A "Snake Animation" representa a minha atividade de commits no GitHub. Ela se move conforme novos commits são feitos.
